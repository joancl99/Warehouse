...
@Component({
  ...
  styles: [`
    ...
    .dash-header__dot {
      ...
      box-shadow: 0 0 8px var(--wh-success);
      animation: pulse-dot 2.4s ease-in-out infinite;
    }

    @keyframes pulse-dot {
      0%, 100% { opacity: 1; box-shadow: 0 0 8px var(--wh-success); }
      50%       { opacity: 0.5; box-shadow: 0 0 3px var(--wh-success); }
    }
    ...
    .kpi-card {
      ...
      &--default::before  { background: var(--wh-border); }
    }
    ...
    .kpi-card--warning .kpi-card__icon-wrap { background: rgba(245,158,11,0.12); }
    .kpi-card--warning .kpi-card__icon-wrap ion-icon { color: #f59e0b; }
    .kpi-card--danger  .kpi-card__icon-wrap { background: rgba(239,68,68,0.12); }
    .kpi-card--danger  .kpi-card__icon-wrap ion-icon { color: #ef4444; }
    .kpi-card--success .kpi-card__icon-wrap { background: rgba(34,197,94,0.12); }
    .kpi-card--success .kpi-card__icon-wrap ion-icon { color: #22c55e; }
    ...
    .alert-item {
      ...
      &:hover { background: var(--wh-surface-hover); }
    }
    ...
    .alert-item__dot {
      ...
      &--sin-stock   { background: #ef4444; }
      &--recuento    { background: #60a5fa; }
    ...
    .alert-item__badge {
      ...
      &--stock-bajo { background: rgba(245,158,11,0.12); color: #f59e0b; }
      &--sin-stock  { background: rgba(239,68,68,0.12);  color: #ef4444; }
      &--recuento   { background: rgba(96,165,250,0.12); color: #60a5fa; }
    }
    ...
    .movement-item__icon {
      ...
      &--entrada  { background: rgba(34,197,94,0.12);  ion-icon { color: #22c55e; } }
      &--salida   { background: rgba(239,68,68,0.12);  ion-icon { color: #ef4444; } }
      &--traslado { background: rgba(96,165,250,0.12); ion-icon { color: #60a5fa; } }
    }
